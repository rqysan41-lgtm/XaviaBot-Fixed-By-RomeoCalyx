...
const langData = {
    ...
    // ====== الردود العربية فقط اتعدلت ======
    ar_SY: {
        notGroup: "هذا الأمر يعمل في المجموعات فقط!",
        dataNotReady: "البيانات غير جاهزة حالياً!",
        botNotAdmin: "البوت يحتاج صلاحية مشرف لتنفيذ هذا الأمر!",
        warns: "⌈ ⚠️ التحذيرات ⚠️ ⌋\n{warns}",
        chooseResetWarn:
            "⌈ ⚠️ التحذيرات ⚠️ ⌋\n{warns}\n\n⇒ رد على هذه الرسالة برقم التحذير الذي تريد مسحه",
        invalidIndex: "الرقم المدخل غير صحيح!",
        confirmResetWarn: "من فضلك تفاعل بـ 👍 للتأكيد!",
        resetSuccess: "تمت العملية بنجاح ✅",
        provideReason: "رد على هذه الرسالة بسبب التحذير!",
        warnConfirm: "من فضلك تفاعل بـ 👍 لتأكيد التحذير!",
        warnSuccess: "تم إرسال التحذير بنجاح ⚠️",
        kickSuccess:
            "⌈ ⚠️ التحذيرات ⚠️ ⌋\n{targetName} تم طرده من المجموعة لأنه حصل على 3 تحذيرات أو أكثر!\n{warns}",
        kickFail:
            "⌈ ⚠️ التحذيرات ⚠️ ⌋\n{targetName} وصل إلى 3 تحذيرات، لكن تعذّر طرده من المجموعة...",
        error: "حصل خطأ، حاول مرة تانية لاحقاً!",
    },
};
